...
class WeightUNet(nn.Module):
    def __init__(self, input_size, timesteps=1000):
        ...
        # Narrower UNet: channels halved from [64,128,256,512] → [32,64,128,256]
        ...
        self.dec4 = self._block(128+128,128)
        self.up3  = nn.ConvTranspose2d(128, 64,2,stride=2)
        self.dec3 = self._block(64+ 64, 64)
        self.up2  = nn.ConvTranspose2d(64,  32,2,stride=2)
        self.dec2 = self._block(32+ 32, 32)
...
def load_checkpoint_weights(checkpoint_path):
    ...
    weights = [param.view(-1) for param in state_dict.values()]
    return torch.cat(weights)

def train_diffusion_model(checkpoint_dir, num_epochs=1000, batch_size=4):
    ...
    save_dir = 'toy_diffusion_checkpoints'
