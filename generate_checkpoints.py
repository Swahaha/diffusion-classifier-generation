...
import os
CHECKPOINT_FOLDER = '/home/users/ren11/project/diffusion-data-aug/resnet_checkpoint' # Change this to your desired checkpoint folder
...
def train_val(model, criterion, optimizer, train_loader, val_loader, device, EPOCHS=100, INITIAL_LR=0.01, STEP_SIZE=30, GAMMA=0.1):
    ...
    for i in range(0, EPOCHS):
        ...
        # Save best model if accuracy is above threshold
        if avg_acc > 0.85:
