...
srun python train_resnet_generated_data.py --dataset map --data_root Synthetic --model deeplabv3plus_resnet50 --output_stride 16 --batch_size 16 --val_batch_size 4 --total_itrs 10000 --lr 0.01 --gpu_id 0